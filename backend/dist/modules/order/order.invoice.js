...
exports.buildOrderInvoicePdf = buildOrderInvoicePdf;
const pdfkit_1 = __importDefault(require("pdfkit"));
function money(value) {
    return `INR ${Number(value).toFixed(2)}`;
}
function drawRow(doc, y, cols) {
...
async function buildOrderInvoicePdf(order) {
    ...
    doc.font("Helvetica").fontSize(9).fillColor("#6B7280").text("This is a computer-generated invoice and does not require a physical signature.", 50, 780, { width: 495, align: "center" });
    doc.end();
    return pdf;
}
